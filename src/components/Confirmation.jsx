    ...
    return (
        <section className="flex flex-col items-center justify-center gap-6 text-center">
            ...
            <div>
                ...
                <p className=" text-grayishBlue">Thank you for expressing your interest in joining the LASU Debate Society.
                    Your application has been successfully submitted. Please check your email for a confirmation message, 
                    and ensure to review your spam or junk folder if it does not appear in your inbox.
                    We appreciate your enthusiasm and look forward to thoroughly reviewing your application.</p>
            </div>
